...
export default function VideoShowcase() {
  ...
  return (
    <section className="py-20 md:py-32 bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="container mx-auto max-w-7xl px-4 relative z-10">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30 mb-6">
            <Award size={16} className="text-amber-400" />
            <span className="text-sm font-semibold text-amber-400">Featured at META 2025</span>
          </span>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              {/* Glow effect */}
              <div className="absolute -inset-2 bg-gradient-to-r from-amber-500/20 to-orange-500/20 rounded-3xl blur-2xl" />
              ...
              <div className="relative aspect-video bg-gray-800 rounded-2xl overflow-hidden border border-gray-700">
                ...
                {!isPlaying && (
                  <div
                    className="absolute inset-0 flex items-center justify-center bg-gray-900/40 cursor-pointer group"
                  ...
                  >
                    <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <Play size={32} className="text-gray-900 ml-1" fill="white" />
                    </div>
                  </div>
                )}

                {/* Duration badge */}
                <div className="absolute bottom-4 left-4 px-3 py-1 bg-gray-900/80 rounded-lg text-gray-900 text-sm font-medium">
                  2:00
                </div>
              </div>
            </div>
          ...
          >
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-amber-400"> It's Better Systems"</span>
            </h3>
            ...
            <Link
              ...
              className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-amber-500 to-orange-500 text-gray-900 font-bold text-lg rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
            >
