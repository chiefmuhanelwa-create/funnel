...
export default function ProblemAgitateSection() {
  ...
  return (
    <section className="py-16 md:py-32 bg-gradient-to-b from-black via-blue-950/5 to-black relative overflow-hidden">
      <div className="container mx-auto max-w-7xl px-4">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tight px-4">
            <span className="text-white block md:inline">You're Creating Content.</span>
            <br className="hidden md:block" />
            <span className="bg-gradient-to-r from-red-400 to-orange-500 bg-clip-text text-transparent">
              But Not Making Money.
            </span>
          </h2>
          <p className="mt-6 text-lg md:text-xl text-blue-200/70 max-w-3xl mx-auto leading-relaxed px-4">
          ...
          {painPoints.map((point, index) => (
            ...
            >
              ...
              <div className="w-9 h-9 md:w-12 md:h-12 rounded-lg md:rounded-xl bg-gradient-to-br from-red-500/20 to-red-500/10 border border-red-500/20 flex items-center justify-center mb-2 md:mb-4 group-hover:scale-110 transition-transform duration-300">
                <point.icon className="w-4 h-4 md:w-6 md:h-6 text-red-400" />
              </div>

              <h3 className="text-sm md:text-lg font-bold text-white mb-1.5 md:mb-2 leading-tight">
                {point.title}
              </h3>
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Glow Effect */}
          <div className="absolute -inset-4 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 rounded-2xl md:rounded-3xl blur-2xl" />
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative bg-gradient-to-b from-white/[0.05] to-white/[0.02] border border-yellow-500/20 p-6 md:p-12 rounded-2xl md:rounded-3xl"
          >
            {/* Center Icon Container */}
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 flex items-center justify-center mx-auto mb-4 md:mb-6">
              <CheckCircle className="w-6 h-6 md:w-8 md:h-8 text-yellow-400" />
            </div>

            {/* Headline */}
            <h3 className="text-2xl md:text-4xl font-black text-white text-center tracking-tight mb-4 md:mb-6 px-4">
            ...
            <div className="text-center mb-4 md:mb-6 px-4">
              ...
              <p className="text-xl md:text-2xl font-black bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mt-2">
                Content monetization systems do.
              </p>
            </div>

            {/* Follow-up Copy */}
            <p className="text-base md:text-lg text-blue-200/60 text-center max-w-2xl mx-auto leading-relaxed px-4">
