...
export async function getContactByEmail(email: string): Promise<any | null> {
  try {
    ...
    console.error('[RESEND] Get contact error:', error);
    return null;
  }
}
 ...
 * Automatically handles duplicates by updating instead
 */
...
export async function sendMilestoneEmail(
  email: string,
  milestone: 'first_lesson' | 'module_1_complete' | 'all_complete',
  firstName?: string
): Promise<boolean> {
  try {
    const name = firstName || email.split('@')[0];
    const emailContent = getMilestoneEmailContent(milestone, name);
    ...
    console.log(`[RESEND] Sent ${milestone} email to ${email}`);
    return true;
  } catch (error: any) {
    console.error(`[RESEND] Milestone email error:`, error.message);
    return false;
  }
}
...
// Base email styles
const emailStyles = `
  body { font-family: 'Open Sans', Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f4f4f4; }
  ...
  .header { background: linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 100%); color: #FFD700; padding: 30px 20px; text-align: center; }
  ...
  .highlight-box { background: #f8f9fa; padding: 20px; border-left: 4px solid #FFD700; margin: 20px 0; }
...
/**
 * Get welcome email content based on sequence number
 */
function getWelcomeEmailContent(emailNumber: number, name: string): { subject: string; html: string } {
  const emails: Record<number, { subject: string; html: string }> = {
    1: { subject: '🎉 Welcome to the Contentpreneur Family!', html: getWelcomeEmail1HTML(name) },
    2: { subject: '💰 The PAIDS Framework That Changed Everything', html: getWelcomeEmail2HTML(name) },
    3: { subject: 'Quick Question: Have You Started Module 1?', html: getWelcomeEmail3HTML(name) },
    7: { subject: '📊 Your Week 1 Progress Report', html: getWelcomeEmail7HTML(name) },
    14: { subject: '🎁 Bonus Content Unlocked!', html: getWelcomeEmail14HTML(name) },
    21: { subject: "You're 21 Days In - Here's What's Next", html: getWelcomeEmail21HTML(name) },
    30: { subject: 'Share Your Story (+ Exclusive Offer Inside)', html: getWelcomeEmail30HTML(name) },
  };
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p><strong>Module 1: Introduction to Personal Branding</strong><br/>Duration: 15 minutes<br/>Your first breakthrough awaits.</p>
      <p style="text-align: center;"><a href="https://contentpreneurhub.online/members" class="cta-button">Access Your Training Now →</a></p>
      <div class="warning-box">
        <p style="margin: 0;"><strong>⚡ Quick Win Challenge:</strong><br/>Download the Niche Finder Workbook and complete Exercise 1 today. It takes 10 minutes and will give you clarity you've been missing for months.</p>
      </div>
      ...
      <p style="margin-top: 30px;"><strong>Ndivhuwo "NO CHILL" Mulaudzi</strong><br/>CEO, NOCHILL PTY LTD<br/><a href="https://contentpreneurhub.online" style="color: #1a5a8a;">contentpreneurhub.online</a></p>
    </div>
    <div class="footer">
      <p>NOCHILL PTY LTD © 2026 | Johannesburg, South Africa</p>
      <p style="font-size: 12px; margin-top: 10px;"><a href="https://contentpreneurhub.online/unsubscribe" style="color: #666;">Unsubscribe</a> | <a href="https://contentpreneurhub.online/privacy" style="color: #666;">Privacy Policy</a></p>
    </div>
  </div>
</body>
</html>`;
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div style="background: #fff; border-left: 4px solid #FFD700; padding: 15px; margin: 10px 0;"><h4 style="margin: 0 0 10px 0; color: #0a0a0a;">💼 P - PRODUCTS</h4><p style="margin: 0;">Digital products, courses, templates. Create once, sell forever.</p></div>
      <div style="background: #fff; border-left: 4px solid #FFD700; padding: 15px; margin: 10px 0;"><h4 style="margin: 0 0 10px 0; color: #0a0a0a;">📢 A - ADS & AFFILIATES</h4><p style="margin: 0;">Platform revenue + affiliate commissions. Passive income while you sleep.</p></div>
      <div style="background: #fff; border-left: 4px solid #FFD700; padding: 15px; margin: 10px 0;"><h4 style="margin: 0 0 10px 0; color: #0a0a0a;">📚 I - INFORMATION</h4><p style="margin: 0;">Paid newsletters, premium content, membership communities.</p></div>
      <div style="background: #fff; border-left: 4px solid #FFD700; padding: 15px; margin: 10px 0;"><h4 style="margin: 0 0 10px 0; color: #0a0a0a;">🤝 D - DEALS</h4><p style="margin: 0;">Brand partnerships, sponsored content.</p></div>
      <div style="background: #fff; border-left: 4px solid #FFD700; padding: 15px; margin: 10px 0;"><h4 style="margin: 0 0 10px 0; color: #0a0a0a;">💼 S - SERVICES</h4><p style="margin: 0;">Consulting, coaching, done-for-you services.</p></div>
      ...
      <p style="text-align: center;"><a href="https://contentpreneurhub.online/members" class="cta-button">Access PAIDS Workbook →</a></p>
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="text-align: center;"><a href="https://contentpreneurhub.online/members" class="cta-button">Start Module 1 Now →</a></p>
      <p><strong>Need help?</strong> Hit reply and tell me what's holding you back.</p>
      <p>I'm rooting for you,<br/><strong>Ndivhuwo</strong></p>
    </div>
  </div>
</body>
</html>`;
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="text-align: center;"><a href="https://contentpreneurhub.online/members" class="cta-button">Continue Learning →</a></p>
      <p>To your success,<br/><strong>Ndivhuwo</strong></p>
    </div>
  </div>
</body>
</html>`;
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="text-align: center;"><a href="https://contentpreneurhub.online/members" class="cta-button">Access Your Content →</a></p>
      <p>Keep pushing,<br/><strong>Ndivhuwo</strong></p>
    </div>
  </div>
</body>
</html>`;
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="warning-box">
        <p style="margin: 0;"><strong>This week's focus:</strong><br/>Finish any incomplete modules and pick your first income stream to focus on.</p>
      </div>
      <p style="text-align: center;"><a href="https://contentpreneurhub.online/members" class="cta-button">Check Your Progress →</a></p>
      <p>We're almost at the finish line,<br/><strong>Ndivhuwo</strong></p>
    </div>
  </div>
</body>
</html>`;
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="text-align: center;"><a href="https://contentpreneurhub.online/contentpreneur-starter-kit" class="cta-button">Explore More Resources →</a></p>
      <p>Proud of how far you've come,<br/><strong>Ndivhuwo</strong><br/>CEO, NOCHILL PTY LTD</p>
    </div>
    <div class="footer">
      <p>NOCHILL PTY LTD © 2026 | Johannesburg, South Africa</p>
    </div>
...
/**
 * Get milestone email content
 */
function getMilestoneEmailContent(milestone: string, name: string): { subject: string; html: string } {
  const templates: Record<string, { subject: string; html: string }> = {
    ...
    module_1_complete: {
      subject: '🏆 Module 1 Complete - Major Progress!',
      html: getFirstLessonEmailHTML(name), // Same template
    },
    all_complete: {
  ...
  return templates[milestone] || templates.first_lesson;
}
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="warning-box">
        <p style="margin: 0;"><strong>Keep the momentum going!</strong><br/>The next module builds directly on what you just learned. Try to complete it within 24 hours.</p>
      </div>
      <p style="text-align: center;"><a href="https://contentpreneurhub.online/members" class="cta-button">Continue to Next Module →</a></p>
      <p>You're on your way,<br/><strong>Ndivhuwo</strong></p>
    </div>
  </div>
</body>
</html>`;
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="text-align: center;"><a href="https://contentpreneurhub.online/members" class="cta-button">Review Your Progress →</a></p>
      <p>Incredibly proud of you,<br/><strong>Ndivhuwo "NO CHILL" Mulaudzi</strong><br/>CEO, NOCHILL PTY LTD</p>
    </div>
    <div class="footer">
